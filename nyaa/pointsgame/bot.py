...
class BotChat(object):
  ...
  BetWin = u"{} has won the bet! (2{} ʀᴘ)"
  BetLose = u"{} has lost the bet. (2{} ʀᴘ)"
  BetNotEnoughPoints = "{}: You don't have enough rupees. Go cut down some hedges or break some pots for more!"
  MultiBet = u"{}: Won: {} times (3+{} ʀᴘ) - Lost: {} times (4-{} ʀᴘ) - Current: {} ʀᴘ"
  Stats = u"{} a total of 3{} rupees!"
  Stats_My = "{}: You have"
  Stats_NotMy = "{} has"
  ...
  StoreItem = u"Item: %s | Price: %s ʀᴘ | Active for: %s | Quantity: %s | To buy: .buy %s"
  TopPlayer = "#{}4 {} with2 {} rupees; "
  WelcomeDefault = "Hello {}-san!"
  Pets = "pets {}"
  BreakPot = "You've broken a pot and found {} rupees."
